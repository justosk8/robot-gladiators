...
for(var i = 0; i < enemyNames.length; i++) {
  // if player is still alive, keep fighting
    ...
    // reset eneyHealth before starting new fight
    enemyHealth = 50;
    
    // use debugger to pause script from running and check what's going on at that moment with the code
    // debugger;

    // pass the pickedEnemyName variable's value into the fight function, where it wekk assume the value of the enemyName parameter
